	...
	public function update(Request $request)
	{
		...
		try {
            ...
            if($request->introduction_image) {
                if($object->introduction_image) {
                    FileHelper::forceDeleteFiles($object->introduction_image->id, $object->id, ThisModel::class, 'introduction_image');
                }
                FileHelper::uploadFile($request->introduction_image, 'configs', $object->id, ThisModel::class, 'introduction_image',99);
            }
